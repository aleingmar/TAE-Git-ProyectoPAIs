...
@Service
public class AdministrativoMedicoListService extends AbstractService<Administrativo, Medico> {
	...
	public void unbind(final Medico object) {
		...
		assert object != null;
		Tuple tuple;
		tuple = super.unbind(object, "especialidad", "tipoMedico", "dni", "userAccount.username", "userAccount.identity.email");

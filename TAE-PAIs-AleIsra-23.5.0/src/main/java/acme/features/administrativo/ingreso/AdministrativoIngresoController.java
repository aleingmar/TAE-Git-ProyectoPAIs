...
@Controller
public class AdministrativoIngresoController extends AbstractController<Administrativo, Ingreso> {
	...
	@Autowired
	protected AdministrativoIngresoListService		listService;

	@Autowired
	protected AdministrativoIngresoShowService		showService;

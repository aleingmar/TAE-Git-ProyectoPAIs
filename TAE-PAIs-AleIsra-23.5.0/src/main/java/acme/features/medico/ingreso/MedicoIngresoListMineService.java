...
@Service
public class MedicoIngresoListMineService extends AbstractService<Medico, Ingreso> {
	...
	public void load() {
		...
		objects = this.repository.findManyIngresosByMedicoId(principal.getActiveRoleId());

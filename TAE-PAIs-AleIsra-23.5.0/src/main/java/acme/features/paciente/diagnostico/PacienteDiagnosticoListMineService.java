...
@Service
public class PacienteDiagnosticoListMineService extends AbstractService<Paciente, Diagnostico> {

	// Internal state ---------------------------------------------------------

	@Autowired
	protected PacienteDiagnosticoRepository repository;
	...
	public void load() {
		...
		objects = this.repository.findManyDiagnosticosByPacienteId(principal.getActiveRoleId());

...
@Controller
public class AdministratorMedicoController extends AbstractController<Administrator, Medico> {
	...
	@Autowired
	protected AdministratorMedicoListService	listService;

	@Autowired
	protected AdministratorMedicoShowService	showService;

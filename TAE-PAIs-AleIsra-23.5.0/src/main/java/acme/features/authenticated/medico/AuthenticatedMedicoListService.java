/*
 * AuthenticatedMedicoListService.java
 *
...
@Service
public class AuthenticatedMedicoListService extends AbstractService<Authenticated, Medico> {
	...
	@Autowired
	protected AuthenticatedMedicoRepository repository;

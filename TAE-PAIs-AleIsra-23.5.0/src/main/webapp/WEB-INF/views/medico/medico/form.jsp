...
<acme:form>
	<acme:input-textbox code="medico.medico.form.label.nombreUsuario" path="userAccount.username" readonly="true"/>
	<acme:input-email code="medico.medico.form.label.email" path="userAccount.identity.email" readonly="true"/>
